...
public function __toString(){
    ...
    public function darEquipoGanador(){
        if($this->getCantGolesE1() > $this->getCantGolesE2()){
            $equipoGanador = $this->getCantGolesE1();
        } elseif($this->getCantGolesE1() < $this->getCantGolesE2()){
            $equipoGanador = $this->getCantGolesE2();
        } elseif($this->getCantGolesE1() == $this->getCantGolesE2()){
            $equipoGanador = array($this->getCantGolesE1(), $this->getCantGolesE2());
        }
    ...
    public function coeficientePartido(){
        ...
        $totalGolesPartido = $this->getCantGolesE1() + $this->getCantGolesE2();
        $cantJugadoresEquipo1 = $this->getObjEquipo1()->getCantJugadores();
        $cantJugadoresEquipo2 = $this->getCantGolesE2()->getCantJugadores();
        $totalJugadoresPartido = $cantJugadoresEquipo1 + $cantJugadoresEquipo2;

        // Calculo del coeficiente

        $coeficientePartido = $this->getCoefBase()*$totalGolesPartido*$totalJugadoresPartido;
